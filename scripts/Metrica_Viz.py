...
def plot_pitch( field_dimen = (106.0, 68), field_color ='city-blue', linewidth=2, markersize=20):
    ...
    -----------
        ...
        field_color: color of field. options are {'city-blue', 'green','white'}
    ...
    # decide what color we want the field to be. Default is a custom 'city-blue', but can also choose green or white
